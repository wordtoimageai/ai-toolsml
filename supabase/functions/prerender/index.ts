...
// Complete tool metadata for all tools - synced with src/data/tools.ts
const toolsMetadata: Record<string, { title: string; description: string; category: string; rating: string; company: string }> = {
  ...
  'perplexity': { title: 'Perplexity', description: 'AI-powered search engine with accurate, cited answers in real-time.', category: 'Research', rating: '4.4', company: 'Perplexity AI' },
  ...
  'deepseek': { title: 'DeepSeek', description: 'Open-weight AI model for developers building custom AI applications.', category: 'Coding', rating: '4.2', company: 'DeepSeek' },
  ...
  'hubspot-email-writer': { title: 'HubSpot Email Writer', description: 'AI-powered email copywriting integrated with CRM.', category: 'Marketing', rating: '4.3', company: 'HubSpot' },
  'albert-ai': { title: 'Albert.ai', description: 'Self-optimizing digital advertising platform.', category: 'Marketing', rating: '4.6', company: 'Albert Technologies' },
  'sprout-social': { title: 'Sprout Social', description: 'AI-powered social media management with sentiment analysis.', category: 'Social', rating: '4.4', company: 'Sprout Social' },
  'reply-io': { title: 'Reply.io', description: 'AI-powered sales outreach automation with personalization.', category: 'Sales', rating: '4.2', company: 'Reply' },
  ...
  'wix-adi': { title: 'Wix ADI', description: 'AI-powered website builder that creates custom sites.', category: 'Automation', rating: '4.2', company: 'Wix.com' },
  'loom': { title: 'Loom', description: 'AI-enhanced screen recording and video messaging.', category: 'Productivity', rating: '4.6', company: 'Loom' },
  ...
  'semrush-market-explorer': { title: 'Semrush Market Explorer', description: 'Comprehensive market research and competitor analysis.', category: 'Data', rating: '4.5', company: 'Semrush' },
  'fireflies-ai': { title: 'Fireflies.ai', description: 'AI meeting assistant for transcription and conversation intelligence.', category: 'Productivity', rating: '4.3', company: 'Fireflies.ai' },
  'codesignal': { title: 'CodeSignal', description: 'AI-powered technical assessment and developer evaluation.', category: 'Coding', rating: '4.2', company: 'CodeSignal' },
  'codium-ai': { title: 'CodiumAI', description: 'AI-powered code integrity and test generation.', category: 'Coding', rating: '4.1', company: 'CodiumAI' },
...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Prerender request: path=${path}, format=${format}`);
